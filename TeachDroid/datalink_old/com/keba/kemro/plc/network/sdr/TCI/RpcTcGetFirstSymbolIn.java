...
public class RpcTcGetFirstSymbolIn implements SDR {
   /** Int */
   public int clientId;
   /** Int */
   public int editHnd;
   ...
   public void write(SDROutputStream out, SDRContext context) throws SDRException, IOException {
      ...
      actMember++;
      if (mMemberDone == actMember) {
         out.writeInt(nonTermHnd, context);
         if (!context.done)
            return;
         mMemberDone++;
      }
   ...
   public int size() {
      ...
      size += SDRUtil.sizeInt(nonTermHnd);
      return size;
   }
