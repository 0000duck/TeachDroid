...
public class RpcTcAddDirEntryIn implements SDR {
   /** Int */
   public int clientId;
   /** String */
   public StringBuffer dirPath;
   /** String */
   public StringBuffer dirEntryName;
   /** RpcTcDirEntryKind */
   ...
   public void read(SDRInputStream in, SDRContext context) throws SDRException, IOException {
      ...
      actMember++;
      if (mMemberDone == actMember) {
         dirEntryName = in.readString(dirEntryName, context);
         if (!context.done)
            return;
         mMemberDone++;
      }
   ...
   public void write(SDROutputStream out, SDRContext context) throws SDRException, IOException {
      ...
      actMember++;
      if (mMemberDone == actMember) {
         if (dirEntryName.length() > TCI.rpcMaxPathLen)
            throw new java.lang.IllegalArgumentException();
         out.writeString(dirEntryName, context);
         if (!context.done)
            return;
         mMemberDone++;
      }
   ...
   public int size() {
      ...
      size += SDRUtil.sizeString(dirEntryName);
      size += kind.size();
      return size;
   }
