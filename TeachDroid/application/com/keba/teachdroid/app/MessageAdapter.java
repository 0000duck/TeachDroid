...
public class MessageAdapter<T extends Message> extends BaseAdapter implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8800883933894091537L;

	/**
	 * Contains the list of objects that represent the data of this
	 * MessageAdapter. The content of this list is referred to as "the array" in
	 * the documentation.
	 */
	 ...
	 * this message adapter.
	 */
	private int mResource;

	/**
	 * The resource indicating what views to inflate to display the content of
	 * this message adapter in a drop down widget.
	 */
	...
	// instead as soon as
	// the mFilter MessageFilter is used. mObjects will then only contain the
	// filtered values.
	 ...
	 */
	public MessageAdapter(Context context, int textViewResourceId, T[] objects) {
	 ...
	 *            The objects to represent in the ListView.
	 */
	public MessageAdapter(Context context, int resource, int textViewResourceId, T[] objects) {
	 ...
	 *            The objects to represent in the ListView.
	 */
	public MessageAdapter(Context context, int textViewResourceId, List<T> objects) {
	 ...
	 *            The objects to represent in the ListView.
	 */
	public MessageAdapter(Context context, int resource, int textViewResourceId, List<T> objects) {
	...
	/**
	 * Returns the context associated with this message adapter. The context is
	...
	private View createViewFromResource(int position, View convertView, ViewGroup parent, int resource) {
		...
		try {
			...
			Log.e("MessageAdapter", "You must supply a resource ID for a TextView");
			throw new IllegalStateException("MessageAdapter requires the resource ID to be a TextView", e);
		}
		...
		if (item instanceof CharSequence) {
			...
			text.setCompoundDrawablesWithIntrinsicBounds(getContext().getResources().getDrawable(item.mImageId), null, null, null);
		}
	...
	/**
	 * <p>
	 * An array filter constrains the content of the message adapter with a
	 * prefix. Each item that does not start with the supplied prefix is removed
	 * from the list.
	 * </p>
	 */
	private class MessageFilter extends Filter implements Serializable {
		/**
		 * 
		 */
		private static final long serialVersionUID = -2464818229391036516L;
