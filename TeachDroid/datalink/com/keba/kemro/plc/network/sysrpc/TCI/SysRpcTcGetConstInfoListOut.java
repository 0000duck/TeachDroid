...
public class SysRpcTcGetConstInfoListOut implements XDR {
	public int nrOfInfos;
	public SysRpcTcConstInfo[] infos;  //variable length with max length of TCI.rpcChunkLen
	public int infos_count; //countains the number of elements
	public boolean retVal;

	public SysRpcTcGetConstInfoListOut () {
		infos = new SysRpcTcConstInfo[TCI.rpcChunkLen];
		for (int for_i = 0; for_i < TCI.rpcChunkLen; for_i++) {
			infos[for_i] = new SysRpcTcConstInfo();
		}
	}
