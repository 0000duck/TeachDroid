...
public class RpcTcGetVarInfoListOut implements SDR {
   /** Int */
   public int nrOfInfos;
   public static final int cMaxLen_infos = TCI.rpcChunkLen;
   /** Array<TCI.rpcChunkLen> of RpcTcVarInfo */
   public RpcTcVarInfo[] infos;
   ...
   public void read(SDRInputStream in, SDRContext context) throws SDRException, IOException {
      ...
      if (mMemberDone == actMember) {
         ...
         if (context.done)
            infos = new RpcTcVarInfo[infos_count];
         if (!context.done)
            return;
         mMemberDone++;
      }
