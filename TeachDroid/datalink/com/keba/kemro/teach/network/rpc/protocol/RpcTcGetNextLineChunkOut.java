...
public class RpcTcGetNextLineChunkOut implements XDR {
	public int iterHnd;
	public String[] lines;  //variable length with max length of rpcChunkLen
	public int lines_count; //countains the number of elements
	public boolean retVal;

	public RpcTcGetNextLineChunkOut () {
		lines = new String[rpcChunkLen.value];
	}
