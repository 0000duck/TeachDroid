...
/**
 * 64-Bit Integer - Konstante
 */
public class KStructConstLInt extends KStructConst {
   private static final Long defaultValue = new Long(0);

   KStructConstLInt (String key, KStructType type, int visibility, KTcDfl dfl) {
   ...
   public Object getInitValue () {
      if (m_initValue == null) {
         if (ortsStructuralNode == null) {
            ...
            m_initValue = new Long(value.int64Value);
         }
      }
      return m_initValue;
   }
