 ...
 * String - Konstante
 */
public class KStructConstString extends KStructConst {
   private static final String defaultValue = "";

   KStructConstString (String key, KStructType type, int visibility, KTcDfl dfl) {
