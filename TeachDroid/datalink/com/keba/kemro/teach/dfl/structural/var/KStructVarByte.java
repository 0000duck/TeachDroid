 ...
 * 8 bit variable
 */
public class KStructVarByte extends KStructVarSInt {

	KStructVarByte(String key, int visibility, byte kind, boolean isMapTo,
			boolean isComponent, KStructType type, KTcDfl dfl) {
