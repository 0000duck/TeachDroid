...
public class KvtProgram {
   ...
   /** The  program is opened (only in struct-tree; project not in execution- tree). */
   ...
   private int m_state; // state of the program:
   private KvtProject m_parent;

   /**
    * creates new KvtProgram object
    * @param dirEntry directory entry describing program
    * @param project project for this program
    * @param program program to be represented by this object
    * @param routine unnamed routine
    */
   ...
   /**
    * get program name. This name has to be unique inside of one project. Always use case insensitive operation on this name !!!
    ...
    *
    * @param newState Neuer Programmzustand
    */
   ...
   /**
    * Überprüft den aktuellen Programmstatus. Wenn doFire und sich der 
    * Status geändert hat wird ein Prgramstate Changed ausgelöst.
    *
    * @param doFire Wenn true werden Listener benachrichtigt.
    */
    ...
    *
    * @param newPrg Der KStructProgram Knoten
    */
    ...
    *
    * @param execUnnamedRoutine Ausführungseinheit für die unbenannte Routine
    */
