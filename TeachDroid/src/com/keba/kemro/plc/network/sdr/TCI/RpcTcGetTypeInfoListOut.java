...
public class RpcTcGetTypeInfoListOut implements SDR {
   /** Int */
   public int nrOfInfos;
   public static final int cMaxLen_infos = TCI.rpcChunkLen;
   /** Array<TCI.rpcChunkLen> of RpcTcTypeInfo */
   public RpcTcTypeInfo[] infos;
   ...
   public void read(SDRInputStream in, SDRContext context) throws SDRException, IOException {
      ...
      if (mMemberDone == actMember) {
         ...
         if (context.done)
            infos = new RpcTcTypeInfo[infos_count];
         if (!context.done)
            return;
         mMemberDone++;
      }
