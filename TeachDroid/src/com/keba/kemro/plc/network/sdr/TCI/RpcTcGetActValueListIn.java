...
public class RpcTcGetActValueListIn implements SDR {
   /** Int */
   public int clientId;
   /** Int */
   ...
   public void read(SDRInputStream in, SDRContext context) throws SDRException, IOException {
      ...
      actMember++;
      if (mMemberDone == actMember) {
         nrOfActValues = in.readInt(context);
         if (!context.done)
            return;
         mMemberDone++;
      }
   ...
   public void write(SDROutputStream out, SDRContext context) throws SDRException, IOException {
      ...
      actMember++;
      if (mMemberDone == actMember) {
         out.writeInt(nrOfActValues, context);
         if (!context.done)
            return;
         mMemberDone++;
      }
   ...
   public int size() {
      ...
      size += SDRUtil.sizeInt(nrOfActValues);
