...
public class SysRpcTcGetRoutineInfoListOut implements XDR {
	public int nrOfInfos;
	public SysRpcTcRoutineInfo[] infos;  //variable length with max length of TCI.rpcChunkLen
	public int infos_count; //countains the number of elements
	public boolean retVal;

	public SysRpcTcGetRoutineInfoListOut () {
		infos = new SysRpcTcRoutineInfo[TCI.rpcChunkLen];
		for (int for_i = 0; for_i < TCI.rpcChunkLen; for_i++) {
			infos[for_i] = new SysRpcTcRoutineInfo();
		}
	}
