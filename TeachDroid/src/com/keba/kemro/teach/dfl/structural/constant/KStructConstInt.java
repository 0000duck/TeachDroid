...
/**
 * 16-Bit Integer-Konstante
 */
public class KStructConstInt extends KStructConstDInt {
   private static final Short defaultValue = new Short((short) 0);

   KStructConstInt (String key, KStructType type, int visibility, KTcDfl dfl) {
   ...
   public Object getInitValue () {
      if (m_initValue == null) {
         if (ortsStructuralNode == null) {
            ...
            m_initValue = new Short(value.int16Value);
         }
      }
      return m_initValue;
   }
